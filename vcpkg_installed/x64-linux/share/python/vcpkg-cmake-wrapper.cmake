...
if(_PythonFinder_WantLibs)
    ...
    set(_Python_INCLUDE_DIR "${_Python_INCLUDE_DIR}")
    set(_Python_LIBRARY_RELEASE "${_Python_LIBRARY_RELEASE}")
    set(_Python_LIBRARY_DEBUG "${_Python_LIBRARY_DEBUG}")
...
if(TARGET Python::Python)
    target_compile_definitions(Python::Python INTERFACE "$<$<CONFIG:Debug>:Py_DEBUG>")
endif()
if(TARGET Python::Module)
    target_compile_definitions(Python::Module INTERFACE "$<$<CONFIG:Debug>:Py_DEBUG>")
endif()
